...
const mockTransactions: Transaction[] = [
  { id: '1', type: 'tap', amount: 10.00, status: 'completed', date: 'منذ ساعة', description: '100 تكبيسة يومية' },
  ...
  { id: '6', type: 'tap', amount: 10.00, status: 'completed', date: 'قبل يومين', description: '100 تكبيسة يومية' },
    ...
    <div className="space-y-6">
      ...
      <Tabs value={filter} onValueChange={(v) => setFilter(v as any)} dir="rtl">
        <TabsList className="grid w-full grid-cols-5">
          <TabsTrigger value="all" data-testid="filter-all">الكل</TabsTrigger>
